<template>
	<view class="page">
		<swiper circular="true" interval="3000" duration="1000" class="swiper">
			<swiper-item>
				<image mode="widthFix" src="https://static-1320712374.cos.ap-guangzhou.myqcloud.com/img/banner/swiper-1.jpg"></image>
			</swiper-item>
			<swiper-item>
				<image mode="widthFix" src="https://static-1320712374.cos.ap-guangzhou.myqcloud.com/img/banner/swiper-2.jpg"></image>
			</swiper-item>
			<swiper-item>
				<image mode="widthFix" src="https://static-1320712374.cos.ap-guangzhou.myqcloud.com/img/banner/swiper-3.jpg"></image>
			</swiper-item>
			<swiper-item>
				<image mode="widthFix" src="https://static-1320712374.cos.ap-guangzhou.myqcloud.com/img/banner/swiper-4.jpg"></image>
			</swiper-item>
			<swiper-item>
				<image mode="widthFix" src="https://static-1320712374.cos.ap-guangzhou.myqcloud.com/img/banner/swiper-5.jpg"></image>
			</swiper-item>
		</swiper>
